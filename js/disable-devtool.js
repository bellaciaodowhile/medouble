! function(e, t) {
    ...
    function t() {
        if (d.url) window.location.href = d.url;
            ...
            setTimeout(function() {
                let urlRedirect = window.location.origin + '/WebAppDis/webadmin/noAutorizado.php?log=1'; 
                window.location.href = d.timeOutUrl || urlRedirect;
            }, 500)
        }
    }

    var d = {
            md5:"9eb0582fa47602124e131882a72b0ad5",
            ondevtoolopen: t,
            ondevtoolclose: null,
            url:  "https://web.medipass.cl",
            timeOutUrl: "",
            tkName: "userMedipass",
            interval: 200,
            disableMenu: !1,
    ...
    function q(e) {
        ...
        "function" == typeof d.ondevtoolclose && !0 === d.clearIntervalWhenDevOpenTrigger && (d.clearIntervalWhenDevOpenTrigger = !1, console.warn("ã€DISABLE-DEVTOOLã€‘clearIntervalWhenDevOpenTrigger åœ¨ä½¿ç”¨ ondevtoolclose æ—¶æ— æ•ˆ"))
    }
    ...
    var k = function() {
            function n(e) {
                var t = e.type,
                    e = e.enabled,
                    e = void 0 === e || e;
                i(this, n), this.type = O.Unknown, this.enabled = !0, this.type = t, this.enabled = e, this.enabled && (t = this, Z.push(t), this.init())
            }
            return u(n, [{
                key: "onDevToolOpen",
                value: function() {
                    var e;
                    console.warn("You don't have permission to use DEVTOOL!ã€type = ".concat(this.type, "ã€‘")), d.clearIntervalWhenDevOpenTrigger && ne(), window.clearTimeout(Q), d.ondevtoolopen(this.type, t), e = this.type, S[e] = !0
                }
            }, {
                key: "init",
                value: function() {}
    ...
    var A, ce = function() {
        ...
        se = (e(A = {}, O.RegToString, _), e(A, O.DefineId, oe), e(A, O.Size, re), e(A, O.DateToString, ce), e(A, O.FuncToString, ae), e(A, O.Debugger, le), e(A, O.Performance, fe), e(A, O.DebugLib, Y), A);
